...
from adapter.util import resize_numpy_image
...
def get_cond_model(opt, cond_type: ExtraCondition):
    if cond_type == ExtraCondition.sketch:
        from adapter.modules.extra_condition.model_edge import pidinet
        model = pidinet()
        ckp = torch.load('extensions-builtin/sd-webui-controlnet/annotator/downloads/pidinet/table5_pidinet.pth', map_location='cpu')['state_dict']
        ...
        det_checkpoint = 'extensions-builtin/sd-webui-controlnet/annotator/ckpts/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth'
        pose_config = os.path.join(scripts.basedir, 'configs/mm/hrnet_w48_coco_256x192.py')
        pose_checkpoint = 'extensions-builtin/sd-webui-controlnet/annotator/ckpts/hrnet_w48_coco_256x192-b9e0b3ab_20200708.pth'
        ...
        from adapter.modules.extra_condition.midas.api import MiDaSInference
        ...
        from adapter.modules.extra_condition.openpose.api import OpenposeInference
...
def get_cond_keypose(opt, cond_image, cond_inp_type='image', cond_model=None):
    ...
    if cond_inp_type == 'keypose':
        ...
        from adapter.modules.extra_condition.utils import imshow_keypoints
